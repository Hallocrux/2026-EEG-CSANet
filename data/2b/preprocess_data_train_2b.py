...
all_data_files = [
    ["B0" + str(i) + "0" + str(j) + "T.gdf" for j in range(1, 4)] for i in range(1, 10)
]

label_path = "E:/Dataset/BCI_Competition_IV/True_Labels/Datasets2b"
all_label_files = [
    ["B0" + str(i) + "0" + str(j) + "T.mat" for j in range(1, 4)] for i in range(1, 10)
]
...
for sub in range(1, 10):
    ...
    for i in range(len(data_files)):
        raw_data = mne.io.read_raw_gdf(
            os.path.join(data_path, data_files[i]), preload=True, verbose=False
        )
