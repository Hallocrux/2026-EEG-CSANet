...
# copy from eeg-conformer

import numpy as np
import scipy.io

root_path = "/Data/SEED/seed_cxr/data/"
save_path = "/Data/SEED/seed_cxr/data_cv5fold/"
...
for i in range(15):
    ...
    for j in range(3):
        ...
        for k in range(15):
            one_trial = []
            trial_tmp = scipy.io.loadmat(
                root_path + "S%d_%d_%d.mat" % (i + 1, j + 1, k + 1)
            )
